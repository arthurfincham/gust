...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`bg-white w-full h-[50px]  px-4 w-full  flex justify-center ${navShadow} fixed`}
        ...
        <div className="flex items-center w-full navContent">
          ...
          <div className="flex justify-end w-full ml-6 space-x-4 ">
            <NavLink
              ...
              className="mx-2 mt-1 bg-white rounded-md text-md hover:cursor-pointer font-sans-bb"
              to="/"
            >
              Home
            </NavLink>
