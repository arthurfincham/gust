  ...
  const FormField = ({ type, name, placeholder, className }) => {
    return (
      <input
        ...
        className={`${className} h-[50px] p-3 py-4 text-lg bg-gray-50 roboto-regular border-2 rounded-lg focus:outline-primary-600 border-2 border-primary-300 m-3 shadow-md placeholder:font-hand placeholder:text-2xl`}
      />
    );
  };
      ...
      <div className="flex flex-col items-center justify-around w-full h-auto p-4 bg-white shadow-xl rounded-xl">
        ...
        <form className="flex flex-col items-center justify-between w-11/12 max-w-[600px] ">
          <div className="flex flex-col items-center justify-between w-full sm:flex-row">
            <FormField type="text" name="firstName" placeholder="first name" className="w-full ml-3 sm:w-1/2 sm:ml-0" />
            <FormField type="text" name="firstName" placeholder="last name" className="w-full mr-3 sm:w-1/2 sm:mr-0" />
          </div>
          <FormField type="email" name="email" placeholder="email address" className="w-full" />
          <FormField type="password" name="password" placeholder="password" className="w-full" />
          <FormField type="password" name="passwordConfirmation" placeholder="confirm your password" className="w-full" />
          <input
            type="submit"
            name="Send"
            value="Sign Up"
