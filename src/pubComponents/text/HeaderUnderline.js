  ...
  return (
    <div className="flex items-center justify-center w-auto h-auto p-8 bg-white shadow-xl rounded-xl">
      <div className="relative float-left text-center ">
        <h1
          className="mb-1 text-4xl text-black dark:text-white lg:text-6xl scroll-mt-24"
          id={text.toLowerCase()}
          ref={ref}
        >
          {text}
        ...
        <svg
          className="mt-[-10px] absolute stroke-primary-600"
          left="0"
          right="0"
          width="100%"
          height="100%"
        ...
        >
          ...
          <path
            id="pathItem"
            d={`M5 ${startPoint} Q ${svgWidth /
              pivotPoint} ${midPoint} ${svgWidth} ${endPoint}`}
            fill="transparent"
            strokeWidth="4"
            strokeLinecap="round"
          />
