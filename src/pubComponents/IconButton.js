export default function IconButton() {
  const icon = (
    <svg className="w-[35px] fill-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 268 267">
      <g>
  ...
  return (
    <div className="flex items-center justify-center w-2/3 py-6 bg-white md:w-1/3 rounded-xl h-5/6">
      <button className="flex items-center justify-around w-auto p-2 space-x-2 shadow-lg hover:bg-primary-700 bg-primary-600 rounded-xl hover:shadow-primary-200/40">
        {icon}
        <span className="tracking-wide text-white whitespace-nowrap font-sans-b">Icon Button</span>
      </button>
    </div>
  );
}
